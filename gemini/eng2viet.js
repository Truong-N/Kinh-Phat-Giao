...
function handleH1() {
    ...
    if (elCt.length > 0) {
        ...
        // textareaEnglish.value += `<h1> <span class="english"> ${elCt} </span>\n`;
        increaseLineNo()
    } else {
...
function handleH2() {
    ...
    if (elCt.length > 0) {
        ...
        // textareaEnglish.value += `<h2> <span class="english"> ${elCt} </span>\n`;
        increaseLineNo()
    } else {
        alert("Textarea above is empty!")
    }
...
function handleH3() {
    ...
    if (elCt.length > 0) {
        ...
        // textareaEnglish.value += `<h3> <span class="english"> ${elCt} </span>\n`;
        increaseLineNo()
    } else {
        alert("Textarea above is empty!")
    }
...
function handleH4() {
    ...
    if (elCt.length > 0) {
        ...
        // textareaEnglish.value += `<h4> <span class="english"> ${elCt} </span>\n`;
        increaseLineNo()
    } else {
        alert("Textarea above is empty!")
    }
...
function processHTMLHeader() {
    ...
    // textareaEnglish.value += `<${selectedTag}> <span class="english"> ${elementContent.value.replaceAll("<", "&lt;").trim()} </span>\n`;
    ctr++;
    document.querySelector(".start").value = ctr;
    localStorage.setItem("lineNum", ctr)
    elementContent.value = ""
...
function processParagraph(paragraph) {
    ...
    const arrayLines = paragraph
        ...
        .split("~")
        .map(item => {
            let txt = `<span class="english ${ctr}"> ${item} </span>\n`;
            increaseLineNo()
            // return `<span class="english"> ${item} </span>\n`;
            return txt
        })
...
function handleUl() {
    ...
    arrayLi.forEach((liItem) => {
        if (liItem.length > 1) {
            ...
            // textareaEnglish.value += `<li> <span class="english"> ${liItem} </span>\n`;
            ctr++;
        }
    })
    increaseLineNo()
